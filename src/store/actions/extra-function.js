...
import { ChainIDS, divBy, mulBy, roundNumber, stringify, toNum } from "./common-functions";
      ...
      try {
        ...
        try {
          ...
          await API({
            ...
            method: "POST",
            body: {
              no_of_copies: parseInt(await contract.balanceOf(account, tokenId)),
              owner_id: UserID,
          ...
          if (Contrat_type) {
            ...
            nftObject["own_copies"] = parseInt(await contract.balanceOf(Owner_address, tokenId));
          } else {
            await API({
